...
namespace ForqStudio.Application.IntegrationTests.Sandboxes;
...
public class CreateSandboxIntegrationTests : BaseIntegrationTest
{
    ...
    public async Task SaveChanges_PersistsSandbox_AndWritesOutboxMessage()
    {
        ...
        var dbContext = scope.ServiceProvider.GetRequiredService<ForqStudio.Infrastructure.ApplicationDbContext>();
