...
using Alcatraz.Application.UnitTests.Permissions;
using Alcatraz.Domain.Users;
using FluentAssertions;
using NSubstitute;

namespace Alcatraz.Application.UnitTests.Roles;
...
public class CreateRoleTests
{
    ...
    {
        var unitOfWorkMock = Substitute.For<Alcatraz.Domain.Abstractions.IUnitOfWork>();
