...
namespace ForqStudio.Infrastructure.Migrations
{
    ...
    [Migration("20260508192444_Add_Sandbox_Endpoint")]
    partial class Add_Sandbox_Endpoint
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ForqStudio.Domain.Apartments.Apartment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ForqStudio.Domain.Bookings.Booking", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ForqStudio.Domain.Reviews.Review", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ForqStudio.Domain.Sandboxes.Sandbox", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ForqStudio.Domain.Users.Permission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("ForqStudio.Domain.Users.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("ForqStudio.Domain.Users.RolePermission", b =>
                {
            ...
            modelBuilder.Entity("ForqStudio.Domain.Users.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ForqStudio.Domain.Users.UserSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ForqStudio.Infrastructure.Outbox.OutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ForqStudio.Domain.Apartments.Apartment", b =>
                {
                    b.OwnsOne("ForqStudio.Domain.Apartments.Address", "Address", b1 =>
                        {
                    ...
                    b.OwnsOne("ForqStudio.Domain.Shared.Money", "CleaningFee", b1 =>
                        {
                            b1.Property<Guid>("ApartmentId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("ForqStudio.Domain.Shared.Money", "Price", b1 =>
                        {
                            b1.Property<Guid>("ApartmentId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("ForqStudio.Domain.Bookings.Booking", b =>
                {
                    b.HasOne("ForqStudio.Domain.Apartments.Apartment", null)
                        .WithMany()
                        .HasForeignKey("ApartmentId")
                    ...
                    b.HasOne("ForqStudio.Domain.Users.User", null)
                        .WithMany()
                    ...
                    b.OwnsOne("ForqStudio.Domain.Shared.Money", "AmenitiesUpCharge", b1 =>
                        {
                    ...
                    b.OwnsOne("ForqStudio.Domain.Shared.Money", "PriceForPeriod", b1 =>
                        {
                            b1.Property<Guid>("BookingId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("ForqStudio.Domain.Shared.Money", "TotalPrice", b1 =>
                        {
                            b1.Property<Guid>("BookingId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("ForqStudio.Domain.Bookings.DateRange", "Duration", b1 =>
                        {
                            b1.Property<Guid>("BookingId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("ForqStudio.Domain.Reviews.Review", b =>
                {
                    ...
                    b.HasOne("ForqStudio.Domain.Bookings.Booking", null)
                        .WithMany()
                        .HasForeignKey("BookingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("ForqStudio.Domain.Users.RolePermission", b =>
                {
                    b.HasOne("ForqStudio.Domain.Users.Permission", null)
                        .WithMany()
                    ...
                    b.HasOne("ForqStudio.Domain.Users.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ForqStudio.Domain.Users.UserSettings", b =>
                {
                    b.HasOne("ForqStudio.Domain.Users.User", null)
                        .WithOne()
                        .HasForeignKey("ForqStudio.Domain.Users.UserSettings", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
