...
using Alcatraz.Application.Permissions.CreatePermission;
using Alcatraz.Application.Permissions.DeletePermission;
using Alcatraz.Application.Permissions.GetPermission;
using Alcatraz.Application.Permissions.GetPermissions;
using Alcatraz.Application.Permissions.UpdatePermission;
...
namespace Alcatraz.Api.Controllers.Permissions;
