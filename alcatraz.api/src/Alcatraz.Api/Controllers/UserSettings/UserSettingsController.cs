...
using Alcatraz.Application.UserSettings.GetUserSettings;
using Alcatraz.Application.UserSettings.UpdateUserSettings;
...
namespace Alcatraz.Api.Controllers.UserSettings;
